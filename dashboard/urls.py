...
urlpatterns = [
    ...
    path('user/articles/<str:pk>/buy', views.buyArticle, name='buy_article'),
    path('user/articles/complete', views.purchaseComplete, name='purchase_complete'),
    path('user/articles/<str:pk>/download', views.downloadArticle, name='download_art'),
    path('user/articles/<str:pk>/download/page', views.downloadPage, name='download_page'),
